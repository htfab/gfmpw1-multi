...
# Tue Dec 12 03:58:56 2023
###############################################################################
current_design mux_wrapper
###############################################################################
# Timing Constraints
###############################################################################
...
# Environment
###############################################################################
set_load -pin_load 0.1900 [get_ports {clk}]
set_load -pin_load 0.1900 [get_ports {rst_n}]
set_load -pin_load 0.1900 [get_ports {wbs_ack_o}]
set_load -pin_load 0.1900 [get_ports {in[18]}]
set_load -pin_load 0.1900 [get_ports {in[17]}]
set_load -pin_load 0.1900 [get_ports {in[16]}]
set_load -pin_load 0.1900 [get_ports {in[15]}]
set_load -pin_load 0.1900 [get_ports {in[14]}]
set_load -pin_load 0.1900 [get_ports {in[13]}]
set_load -pin_load 0.1900 [get_ports {in[12]}]
set_load -pin_load 0.1900 [get_ports {in[11]}]
set_load -pin_load 0.1900 [get_ports {in[10]}]
set_load -pin_load 0.1900 [get_ports {in[9]}]
set_load -pin_load 0.1900 [get_ports {in[8]}]
set_load -pin_load 0.1900 [get_ports {in[7]}]
set_load -pin_load 0.1900 [get_ports {in[6]}]
set_load -pin_load 0.1900 [get_ports {in[5]}]
set_load -pin_load 0.1900 [get_ports {in[4]}]
set_load -pin_load 0.1900 [get_ports {in[3]}]
set_load -pin_load 0.1900 [get_ports {in[2]}]
set_load -pin_load 0.1900 [get_ports {in[1]}]
set_load -pin_load 0.1900 [get_ports {in[0]}]
